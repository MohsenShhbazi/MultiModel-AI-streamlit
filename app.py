...
with st.sidebar:
    ...
    if store_button and file_path:
        try:
            llm_obj = llm.LangChainLLMByGoogle(api_key=GOOGLE_API_KEY, assembly_api=ASSEMBLY_AI_API, kind=kind_of_input)
...
if st.session_state.load_db and Send_button:
    ...
    llm_obj = llm.LangChainLLMByGoogle(api_key=GOOGLE_API_KEY, assembly_api=ASSEMBLY_AI_API, kind="pdf")
